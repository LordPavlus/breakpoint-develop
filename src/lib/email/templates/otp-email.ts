          ...
          <table role="presentation" width="100%" style="max-width: 480px; background-color:#ffffff; border-radius: 12px; overflow: hidden;" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td style="padding: 32px 24px; text-align:center;">
                <p style="margin:0 0 16px; color:#282828; font-size: 16px;">Код для входа на платформу:</p>
                <div style="display:inline-block; padding: 12px 24px; background-color:#f4f4f5; border-radius: 8px; font-size: 32px; font-weight: 700; letter-spacing: 8px; color:#282828;">
                  ${code}
                </div>
